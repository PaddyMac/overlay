...
IUSE="+X adrian-aec +alsa +asyncns avahi bluetooth +caps coreaudio dbus doc equalizer gcov gdbm +glib gnome gtk ipv6 jack libsamplerate \
	lirc neon +nls +orc oss realtime tcpd test +udev solaris speex ssl static-libs system-wide systemd +tdb waveout +webrtc-aec xen"
