...
SRC_URI="https://bitbucket.org/mmueller2012/pipelight/get/v0.2.2.tar.gz -> ${P}.tar.gz
	binary-pluginloader? ( https://launchpad.net/pipelight/trunk/0.2/+download/pluginloader-prebuilt-v0.2.2.tar.xz )"
